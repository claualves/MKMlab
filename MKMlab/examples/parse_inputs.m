...
addParameter(p,'TOF_species',default_params.TOF_species,@iscellstr);
addParameter(p, 'CPT',default_params.CPT, @islogical)
...
options = struct('log',in.log,'TOF_species',{in.TOF_species},...
    'ODE_options',ODE_options,'optim_options',optim_options, 'CPT', in.CPT);
